...
#### Temporal bandpass filter (used DPABI, 0.01~0.1Hz) ####
...
#### Downsample (thalamus ROI selected via fslview) ####
	...
	flirt -in thalamus_mask/R_thal_MNI2mmBrain.nii.gz -ref thalamus_mask/R_thal_MNI2mmBrain.nii.gz -out ${downsample_dir}/R_thal_3mm.nii.gz -applyisoxfm 3 -interp nearestneighbour -omat ${downsample_dir}/R_thal_3mm.mat
	flirt -in thalamus_mask/R_thal_MNI2mmBrain.nii.gz -ref thalamus_mask/R_thal_MNI2mmBrain.nii.gz -out ${downsample_dir}/R_thal_4mm.nii.gz -applyisoxfm 4 -interp nearestneighbour -omat ${downsample_dir}/R_thal_4mm.mat
