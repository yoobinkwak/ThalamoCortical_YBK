...
then
	flirt -in ${reorient_rawT1} -ref ${mni} -omat ${t1w2mni_flirt}.mat -out ${t1w2mni_flirt}.nii.gz -cost mutualinfo -dof 6 -searchrx -180 180 -searchry -180 180 -searchrz -180 180 -usesqform
fi
