...
melodic -i melodic_lists/list_rsFC_ds3_bi.txt -o rsFC_ICA_cmd/ds3_bi_masked -v --nobet --bgthreshold=20 --tr=1 --report --Ostats -a concat -m masks/mni_brain_ds3.nii.gz --bgimage=masks/mni_brain_ds3.nii.gz
...
#melodic -i melodic_lists/re_list_rsFC_ds3_bi.txt -o rsFC_ICA_cmd/re_ds3_bi_20ICs_masked -v --nobet --bgthreshold=20 -d 20 --tr=1 --report --Ostats -a concat -m masks/mni_brain_ds3.nii.gz --bgimage=masks/mni_brain_ds3.nii.gz
#melodic -i melodic_lists/re_list_rsFC_ds3_bi.txt -o rsFC_ICA_cmd/re_ds3_bi_masked -v --nobet --bgthreshold=20 --tr=1 --report --Ostats -a concat -m masks/mni_brain_ds3.nii.gz --bgimage=masks/mni_brain_ds3.nii.gz
#melodic -i melodic_lists/re_list_rsFC_ds3_bi.txt -o rsFC_ICA_cmd/re_ds3_bi_10ICs_masked -v --nobet --bgthreshold=10 -d 10 --tr=1 --report --Ostats -a concat -m masks/mni_brain_ds3.nii.gz --bgimage=masks/mni_brain_ds3.nii.gz



melodic -i melodic_lists/re_list_thalTS_ds3_bi.txt -o thalTS_ICA_cmd/re_ds3_bi_10ICs -v --nobet --bgthreshold=20 -d 10 --tr=3.5 --report --Ostats -a concat --bgimage=masks/bi_thalamus_HOSC_60_ds3.nii.gz
melodic -i melodic_lists/re_list_thalTS_ds3_bi.txt -o thalTS_ICA_cmd/re_ds3_bi_20ICs -v --nobet --bgthreshold=20 -d 20 --tr=3.5 --report --Ostats -a concat --bgimage=masks/bi_thalamus_HOSC_60_ds3.nii.gz
melodic -i melodic_lists/re_list_thalTS_ds3_bi.txt -o thalTS_ICA_cmd/re_ds3_bi -v --nobet --bgthreshold=20 --tr=3.5 --report --Ostats -a concat --bgimage=masks/bi_thalamus_HOSC_60_ds3.nii.gz

melodic -i melodic_lists/re_list_thalTS_bi.txt -o thalTS_ICA_cmd/re_bi_10ICs -v --nobet --bgthreshold=20 -d 10 --tr=3.5 --report --Ostats -a concat --bgimage=masks/bi_thalamus_HOSC_60.nii.gz
melodic -i melodic_lists/re_list_thalTS_bi.txt -o thalTS_ICA_cmd/re_bi_20ICs -v --nobet --bgthreshold=20 -d 20 --tr=3.5 --report --Ostats -a concat --bgimage=masks/bi_thalamus_HOSC_60.nii.gz
melodic -i melodic_lists/re_list_thalTS_bi.txt -o thalTS_ICA_cmd/re_bi -v --nobet --bgthreshold=20 --tr=3.5 --report --Ostats -a concat --bgimage=masks/bi_thalamus_HOSC_60.nii.gz
