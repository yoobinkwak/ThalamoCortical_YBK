...
#images = glob.glob('rsFC_ICA_cmd/NOR_only/NOR_ds3_bi_10ICs_masked/vol*') 
...
#                      #outputDir='figures_20190724/nosmooth_20/ICA/axial', 
#                      outputDir='figures_20190724/nosmooth_10/ICA/axial', 
#                      save=True)
#    
#    get_brain_figures(row['location'], 
#                     title='IC{}_sagittal'.format(row['number']),
#                     #outputDir='figures_20190724/nosmooth_20/ICA/sagittal', 
#                     outputDir='figures_20190724/nosmooth_10/ICA/sagittal', 
#                     save=True,
#                     axial=False)



#source_images = glob.glob('rsFC_Randomise_n80/NOR_only/ds3_bi_nosmooth_20ICs/2_group_tfce/cluster_t0.95_corrp/*_dem*') 
#source_images = glob.glob('rsFC_Randomise_n80/NOR_only/ds3_bi_nosmooth_10ICs/2_group_tfce/cluster_t0.95_corrp/*_dem*') 
#source_images = glob.glob('rsFC_Randomise_n80/NOR_only/ds3_bi_nosmooth_20ICs/nocov_1_sample_tfce/cluster_t0.95_corrp/*_dem*') 
#source_images = glob.glob('rsFC_Randomise_n80/NOR_only/ds3_bi_nosmooth_10ICs/nocov_1_sample_tfce/cluster_t0.95_corrp/*_dem*') 
...
#source_images = glob.glob('rsFC_Randomise_n80/NOR_only/ds3_bi_nosmooth_20ICs/FEP_nocov_1_sample_tfce/cluster_t0.95_corrp/*_dem*') 
#source_images = glob.glob('rsFC_Randomise_n80/NOR_only/ds3_bi_nosmooth_10ICs/NOR_nocov_1_sample_tfce/cluster_t0.95_corrp/*_dem*') 
source_images = glob.glob('rsFC_Randomise_n80/NOR_only/ds3_bi_nosmooth_10ICs/FEP_nocov_1_sample_tfce/cluster_t0.95_corrp/*_dem*') 
...
for index, row in s_df.iterrows():
    get_brain_figures(row['location'], 
                      ...
                      #outputDir='figures_20190724/nosmooth_20/IC_source/axial',
                      #outputDir='figures_20190724/nosmooth_10/IC_source/axial',
                      #outputDir='figures_20190724/nosmooth_20/IC_source_1sample/axial',
                      #outputDir='figures_20190724/nosmooth_10/IC_source_1sample/axial',
                      #outputDir='figures_20190724/nosmooth_20/IC_source_1sample_NOR/axial',
                      #outputDir='figures_20190724/nosmooth_20/IC_source_1sample_FEP/axial',
                      #outputDir='figures_20190724/nosmooth_10/IC_source_1sample_NOR/axial',
                      outputDir='figures_20190724/nosmooth_10/IC_source_1sample_FEP/axial',
                      thalamus_highlight=True,
                      save=True)
    get_brain_figures(row['location'], 
                      title='IC{}_{}_source_sagittal'.format(row['number'], row['stat']),
                      #outputDir='figures_20190724/nosmooth_20/IC_source/saggital', 
                      #outputDir='figures_20190724/nosmooth_10/IC_source/saggital', 
                      #outputDir='figures_20190724/nosmooth_20/IC_source_1sample/saggital', 
                      #outputDir='figures_20190724/nosmooth_10/IC_source_1sample/saggital', 
                      #outputDir='figures_20190724/nosmooth_20/IC_source_1sample_NOR/saggital', 
                      #outputDir='figures_20190724/nosmooth_20/IC_source_1sample_FEP/saggital', 
                      #outputDir='figures_20190724/nosmooth_10/IC_source_1sample_NOR/saggital', 
                      outputDir='figures_20190724/nosmooth_10/IC_source_1sample_FEP/saggital', 
                      save=True,
                      thalamus_highlight=True,
                      axial=False)
    get_brain_figures(row['location'], 
                      title='IC{}_{}_source_sagittal'.format(row['number'], row['stat']),
                      #outputDir='figures_20190724/nosmooth_20/IC_source/brain_saggital', 
                      #outputDir='figures_20190724/nosmooth_10/IC_source/brain_saggital', 
                      #outputDir='figures_20190724/nosmooth_20/IC_source_1sample/brain_saggital', 
                      #outputDir='figures_20190724/nosmooth_10/IC_source_1sample/brain_saggital', 
                      #outputDir='figures_20190724/nosmooth_20/IC_source_1sample_NOR/brain_saggital', 
                      #outputDir='figures_20190724/nosmooth_20/IC_source_1sample_FEP/brain_saggital', 
                      #outputDir='figures_20190724/nosmooth_10/IC_source_1sample_NOR/brain_saggital', 
                      outputDir='figures_20190724/nosmooth_10/IC_source_1sample_FEP/brain_saggital', 
                      save=True,
                      axial=False)
