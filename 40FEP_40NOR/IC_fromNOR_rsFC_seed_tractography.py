...
class subject:
    def __init__(self, subject):
        ...
        self.out_dir = join(self.subject_dir, 'IC_fromNOR_rsFC_seed_tractography')
...
def run_commands(subject_class):
    ...
    for subdir in sub_dir:
        ...
        nocov_input_dir = 'rsFC_Randomise_n80/NOR_only/{}/two_step_randomise/nocov_1_sample_tfce/sig_clusters'.format(subdir)
