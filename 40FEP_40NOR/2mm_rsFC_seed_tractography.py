...
class subject:
    def __init__(self, subject):
        ...
        self.out_dir = join(self.subject_dir, '2mm_rsFC_seed_tractography')
...
def run_commands(subject_class):
    ...
    for subdir in sub_dir:
        ...
        nocov_input_dir = '2mm_sig_clusters/{}/two_step_randomise/nocov_1_sample_tfce/sig_clusters'.format(subdir)
