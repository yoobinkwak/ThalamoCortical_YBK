...
#    fi
    ...
    echo ${i} >> for_corr_subjs.txt
    cat ${outDir}/IC04_demeaned_tfce_corrp_tstat2 >> for_corr_IC04_tstat2.txt
    cat ${outDir}/IC14_demeaned_tfce_corrp_tstat1 >> for_corr_IC14_tstat1.txt
    
    paste for_corr_subjs.txt for_corr_IC14_tstat1.txt | expand -t $(($(wc -L <for_corr_subjs.txt) +1)) >> corr_data.txt
    paste corr_data.txt for_corr_IC04_tstat2.txt | expand -t $(($(wc -L <corr_data.txt) +1)) > corr_data.txt
    sed -i '1i\\subject\tIC14_tstat1\tIC04_stat2' corr_data.txt
