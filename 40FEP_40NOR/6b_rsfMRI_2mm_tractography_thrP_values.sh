...
stat_dir=2mm_Tractography_Values/thrP_ds3_bi_nosmooth_20ICs
mkdir ${stat_dir}
...
do
    ...
    do
        ...
        do
            dir=${i}/2mm_rsFC_seed_tractography/ds3_bi_nosmooth_20ICs/2mm_brain_nosmooth_IC${ic}_demeaned_tfce_corrp_tstat1
		...
		#seed=2mm_sig_clusters/ds3_bi_nosmooth_20ICs/two_step_randomise/nocov_1_sample_tfce/sig_clusters/2mm_brain_t0.95_concatenated_ds3_bi_nosmooth_IC${ic}_demeaned_tfce_corrp_tstat1.nii.gz
...
#cat 5thrP_norm_FA.txt 10thrP_norm_FA.txt  20thrP_norm_FA.txt 90thrP_norm_FA.txt  95thrP_norm_FA.txt > combined_thrP_norm_FA.txt
