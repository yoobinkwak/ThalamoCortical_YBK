...
def mergePerIC(side, voxelsize):
    ...
    randomise_dir = '37FEP36HC_randomise_wmSC_nosmooth'
    ...
    melodicIC_map = nb.load('tica_results/mICA_HCvsFEP_{side}_ds{voxelsize}_nosmooth/dim0/melodic_IC.nii.gz'.format(side=side, voxelsize=voxelsize))
