...
dir_thr=OM2015_group_rsFC/noZnorm_output_group_rsFC/tfce/fwe_corrected_p/95thr_${input}
if [ ! -e ${dir_thr} ] ; then
    mkdir ${dir_thr}
fi

dir_thr_mc=OM2015_group_rsFC/noZnorm_output_group_rsFC/tfce/fwe_corrected_p/mc_95thr_${input}
if [ ! -e ${dir_thr_mc} ] ; then
    mkdir ${dir_thr_mc}
fi

dir_in=OM2015_group_rsFC/noZnorm_output_group_rsFC/tfce/fwe_corrected_p/${input}
...
do
    ...
    if [ ! -e ${tstat1_out} ] ; then
        ...
        zero=0
        if [ ! ${val} -eq ${zero} ] ; then
            echo ${tstat1_out} >> OM2015_group_rsFC/noZnorm_output_group_rsFC/tfce/fwe_corrected_p/survive_95.txt
        fi
    fi
    ...
    if [ ! -e ${tstat1_mc} ] ; then
        ...
        zero=0
        if [ ! ${val} == ${zero} ] ; then
            echo ${tstat1_mc} >> OM2015_group_rsFC/noZnorm_output_group_rsFC/tfce/fwe_corrected_p/survive_mc_95.txt
        fi
    fi
...
do
    ...
    if [ ! -e ${tstat2_out} ] ; then
        ...
        zero=0
        if [ ! ${val} -eq ${zero} ] ; then
            echo ${tstat2_out} >> OM2015_group_rsFC/noZnorm_output_group_rsFC/tfce/fwe_corrected_p/survive_95.txt
        fi
    fi
    ...
    if [ ! -e ${tstat2_mc} ] ; then
        ...
        zero=0
        if [ ! ${val} == ${zero} ] ; then
            echo ${tstat2_mc} >> OM2015_group_rsFC/noZnorm_output_group_rsFC/tfce/fwe_corrected_p/survive_mc_95.txt
        fi
    fi
