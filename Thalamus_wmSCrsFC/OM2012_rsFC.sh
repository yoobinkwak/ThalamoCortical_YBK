...
OM2012_subj=${subj}/OM2012
if [ ! -e ${OM2012_subj} ] ; then
    mkdir ${OM2012_subj}
fi

rs_ds3=${OM2015_subj}/hp2mni_ds3.nii.gz
seed=re_OM2012_tensor_stats/outputs/tfce/fwe_corrected_p/mc_95thr_right_3mm_4fwhm/mc_95thr_right_3mm_4fwhm_IC12_tfce_corrp_tstat1.nii.gz
